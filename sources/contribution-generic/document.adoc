= Template for ITU General Contribution
...
:comment: ### Type of contribution. If there is an attached document that the contribution proposes or updates, use the contribution-revision or contribution-new-item template instead. By default, use `generic`
:subdoctype: generic
